/*	wefax.h
 *
 *  Image decoding funtions for xwefax application
 */

/*
 *  xwefax: An application to decode Radio WEFAX signals from a
 *  Radio Receiver, through the computer's sound card.
 *
 *
